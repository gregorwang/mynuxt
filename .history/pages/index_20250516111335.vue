<template>
  <div>
    <div v-if="isLoading" class="loading-container flex justify-center items-center h-screen">
...
const galleryItems = ref([
  {
    src: 'https://gregorwang.oss-cn-qingdao.aliyuncs.com/gallery1.jpg',
    alt: '青岛风景',
    date: '2024-04-01',
    description: '青岛海边风光',
    source: '个人拍摄'
  ...
  {
    src: 'https://gregorwang.oss-cn-qingdao.aliyuncs.com/gallery2.jpg',
    alt: '工作场景',
    date: '2024-04-02',
    description: '日常工作',
    source: '个人拍摄'
  ...
  {
    src: 'https://gregorwang.oss-cn-qingdao.aliyuncs.com/gallery3.jpg',
    alt: '生活记录',
    date: '2024-04-03',
    description: '生活点滴',
    source: '个人拍摄'
  ...
  {
    src: 'https://gregorwang.oss-cn-qingdao.aliyuncs.com/gallery4.jpg',
    alt: '旅行记忆',
    date: '2024-04-04',
    description: '旅行瞬间',
    source: '个人拍摄'
