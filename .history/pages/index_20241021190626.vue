          ...
          <ul class="list-none p-0 m-0">
            ...
            <li class="inline-block mr-2 relative group">
              ...
              <div class="dropdown-content absolute bg-white shadow-md hidden min-w-[160px] group-hover:block">
                ...
                <NuxtLink to="/test" class="block text-black py-2 px-4">测试专用</NuxtLink>
                <a
                  href="#"
            ...
            <li class="inline-block mr-2 relative">
              <NuxtLink to="/mind" class="text-white text-lg font-bold hover:text-yellow-500 transition-colors duration-300">LLM-FT</NuxtLink> </NuxtLink>
            </li>
          </ul>
        </div>
        <div
